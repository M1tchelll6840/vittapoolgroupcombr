    ...
    <section className="py-20 bg-gradient-water relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Title */}
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-primary-foreground mb-6 animate-fade-in delay-100">
            Pronto para transformar seu espaço?
          </h2>

          {/* Description */}
          <p className="text-lg text-primary-foreground/80 mb-8 animate-fade-in delay-200">
