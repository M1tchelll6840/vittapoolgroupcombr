...
export function ApartmentSection() {
  return (
    <section id="apartamentos" className="py-20 bg-background overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            {/* Floating card */}
            <div className="absolute -bottom-6 -right-6 bg-card p-4 rounded-xl shadow-card max-w-[200px] animate-float">
